...
<body>
<form method='post' action='admin_user_profile.php?id=<?php echo $id;?>' enctype='multipart/form-data'>
<font color='blue' size='5'><?php echo $email; ?></font></br>

<font color='purple' size='4' align='center' margin='auto'>User: <?php echo $store['user_name']; ?></font></br>

Last login time: <input type='text' name='lastlogin' value=' <?php echo $store['login_time']; ?> ' readonly='' disabled='true'></br>

Last logout time: <input type='text' name='lastlogout' value='<?php echo $store['logout_time']; ?>' readonly='readonly' disabled='true'></br>

<table id='tblmain' align='center' border='0'>
	<tr>
		<td colspan='5' align='center'><h1>User Profile</h1><hr height='2' color='#000'></td>
	</tr>
...
<table width='400' align='center' border='3' margin-top='50px'>
	...
	<tr>
		<td colspan='5' align='center'><h1>User Profile</h1></td>
	</tr>
	<tr>
